...
# ACDS 20.1 720 win32 2024.06.10.21:38:26
# ----------------------------------------
...
alias com {
  echo "\[exec\] com"
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/FPMUL.vo"
}
