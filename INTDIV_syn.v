...
//lpm_divide DEVICE_FAMILY="Cyclone V" LPM_DREPRESENTATION="SIGNED" LPM_NREPRESENTATION="SIGNED" LPM_PIPELINE=2 LPM_REMAINDERPOSITIVE="TRUE" LPM_WIDTHD=32 LPM_WIDTHN=32 clken clock denom numer quotient remain
...
//sign_div_unsign DEN_REPRESENTATION="SIGNED" DEN_WIDTH=32 LPM_PIPELINE=2 MAXIMIZE_SPEED=5 NUM_REPRESENTATION="SIGNED" NUM_WIDTH=32 SKIP_BITS=0 clken clock denominator numerator quotient remainder
//VERSION_BEGIN 20.1 cbx_cycloneii 2020:11:11:17:06:45:SJ cbx_lpm_abs 2020:11:11:17:06:45:SJ cbx_lpm_add_sub 2020:11:11:17:06:45:SJ cbx_lpm_divide 2020:11:11:17:06:45:SJ cbx_mgl 2020:11:11:17:08:38:SJ cbx_nadder 2020:11:11:17:06:46:SJ cbx_stratix 2020:11:11:17:06:46:SJ cbx_stratixii 2020:11:11:17:06:46:SJ cbx_util_mgl 2020:11:11:17:06:46:SJ  VERSION_END


//alt_u_div DEVICE_FAMILY="Cyclone V" LPM_PIPELINE=2 MAXIMIZE_SPEED=5 SKIP_BITS=0 WIDTH_D=32 WIDTH_N=32 WIDTH_Q=32 WIDTH_R=32 clk_en clock den_out denominator numerator quotient remainder
//VERSION_BEGIN 20.1 cbx_cycloneii 2020:11:11:17:06:45:SJ cbx_lpm_abs 2020:11:11:17:06:45:SJ cbx_lpm_add_sub 2020:11:11:17:06:45:SJ cbx_lpm_divide 2020:11:11:17:06:45:SJ cbx_mgl 2020:11:11:17:08:38:SJ cbx_nadder 2020:11:11:17:06:46:SJ cbx_stratix 2020:11:11:17:06:46:SJ cbx_stratixii 2020:11:11:17:06:46:SJ cbx_util_mgl 2020:11:11:17:06:46:SJ  VERSION_END
...
//synthesis_resources = lut 560 reg 256 
...
`endif
	...
	assign
		wire_DFFDenominator_d = {DFFDenominator[31:0], denominator};
	// synopsys translate_off
	initial
		DFFNumerator = 0;
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		...
		else if  (clk_en == 1'b1)   DFFNumerator <= {DFFNumerator[31:0], numerator};
	// synopsys translate_off
	initial
	...
	assign
		wire_DFFQuotient_d = {DFFQuotient[31:24], (~ selnose[264]), (~ selnose[297]), (~ selnose[330]), (~ selnose[363]), (~ selnose[396]), (~ selnose[429]), (~ selnose[462]), (~ selnose[495]), (~ selnose[528]), (~ selnose[561]), (~ selnose[594]), (~ selnose[627]), (~ selnose[660]), (~ selnose[693]), (~ selnose[726]), (~ selnose[759]), {8{vcc_wire}}, (~ selnose[0]), (~ selnose[33]), (~ selnose[66]), (~ selnose[99]), (~ selnose[132]), (~ selnose[165]), (~ selnose[198]), (~ selnose[231]), {24{vcc_wire}}};
	// synopsys translate_off
	initial
		DFFStage = 0;
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		...
		else if  (clk_en == 1'b1)   DFFStage <= {StageOut[767:736], StageOut[255:224]};
	assign
	...
	assign
		aclr = 1'b0,
		den_out = DFFDenominator[63:32],
		DenominatorIn = DenominatorIn_tmp,
		DenominatorIn_tmp = {DenominatorIn[1055:792], {gnd_wire, DFFDenominator[63:32]}, DenominatorIn[758:264], {gnd_wire, DFFDenominator[31:0]}, DenominatorIn[230:0], {gnd_wire, denominator}},
		gnd_wire = 1'b0,
		...
		NumeratorIn_tmp = {NumeratorIn[1023:768], DFFNumerator[63:32], NumeratorIn[735:256], DFFNumerator[31:0], NumeratorIn[223:0], numerator},
		...
		quotient_tmp = {DFFQuotient[63:40], (~ selnose[792]), (~ selnose[825]), (~ selnose[858]), (~ selnose[891]), (~ selnose[924]), (~ selnose[957]), (~ selnose[990]), (~ selnose[1023])},
...
(~ nose[253]) | sel[253]), ((~ nose[252]) | sel[252]), ((~ nose[251]) | sel[251]), ((~ nose[250]) | sel[250]), ((~ nose[249]) | sel[249]), ((~ nose[248]) | sel[248]), ((~ nose[247]) | sel[247]), ((~ nose[246]) | sel[246]), ((~ nose[245]) | sel[245]), ((~ nose[244]) | sel[244]), ((~ nose[243]) | sel[243]), ((~ nose[242]) | sel[242]), ((~ nose[241]) | sel[241]), ((~ nose[240]) | sel[240]), ((~ nose[239]) | sel[239]), ((~ nose[238]) | sel[238]), ((~ nose[237]) | sel[237]), ((~ nose[236]) | sel[236]), ((~ nose[235]) | sel[235]), ((~ nose[234]) | sel[234]), ((~ nose[233]) | sel[233]), ((~ nose[232]) | sel[232]), ((~ nose[231]) | sel[231]), ((~ nose[230]) | sel[230]), ((~ nose[229]) | sel[229]), ((~ nose[228]) | sel[228]), ((~ nose[227]) | sel[227]), ((~ nose[226]) | sel[226]), ((~ nose[225]) | sel[225]), ((~ nose[224]) | sel[224]), ((~ nose[223]) | sel[223]), ((~ nose[222]) | sel[222]), ((~ nose[221]) | sel[221]), ((~ nose[220]) | sel[220]), ((~ nose[219]) | sel[219]), ((~ nose[218]) | sel[218]), ((~ nose[217]) | sel[217]), ((~ nose[216]) | sel[216]), ((~ nose[215]) | sel[215]), ((~ nose[214]) | sel[214]), ((~ nose[213]) | sel[213]), ((~ nose[212]) | sel[212]), ((~ nose[211]) | sel[211]), ((~ nose[210]) | sel[210]), ((~ nose[209]) | sel[209]), ((~ nose[208]) | sel[208]), ((~ nose[207]) | sel[207]), ((~ nose[206]) | sel[206]), ((~ nose[205]) | sel[205]), ((~ nose[204]) | sel[204]), ((~ nose[203]) | sel[203]), ((~ nose[202]) | sel[202]), ((~ nose[201]) | sel[201]), ((~ nose[200]) | sel[200]), ((~ nose[199]) | sel[199]), ((~ nose[198]) | sel[198]), ((~ nose[197]) | sel[197]), ((~ nose[196]) | sel[196]), ((~ nose[195]) | sel[195]), ((~ nose[194]) | sel[194]), ((~ nose[193]) | sel[193]), ((~ nose[192]) | sel[192]), ((~ nose[191]) | sel[191]), ((~ nose[190]) | sel[190]), ((~ nose[189]) | sel[189]), ((~ nose[188]) | sel[188]), ((~ nose[187]) | sel[187]), ((~ nose[186]) | sel[186]), ((~ nose[185]) | sel[185]), ((~ nose[184]) | sel[184]), ((~ nose[183]) | sel[183]), ((~ nose[182]) | sel[182]), ((~ nose[181]) | sel[181]), ((~ nose[180]
 ...
 nose[28]) | sel[28]), ((~ nose[27]) | sel[27]), ((~ nose[26]) | sel[26]), ((~ nose[25]) | sel[25]), ((~ nose[24]) | sel[24]), ((~ nose[23]) | sel[23]), ((~ nose[22]) | sel[22]), ((~ nose[21]) | sel[21]), ((~ nose[20]) | sel[20]), ((~ nose[19]) | sel[19]), ((~ nose[18]) | sel[18]), ((~ nose[17]) | sel[17]), ((~ nose[16]) | sel[16]), ((~ nose[15]) | sel[15]), ((~ nose[14]) | sel[14]), ((~ nose[13]) | sel[13]), ((~ nose[12]) | sel[12]), ((~ nose[11]) | sel[11]), ((~ nose[10]) | sel[10]), ((~ nose[9]) | sel[9]), ((~ nose[8]) | sel[8]), ((~ nose[7]) | sel[7]), ((~ nose[6]) | sel[6]), ((~ nose[5]) | sel[5]), ((~ nose[4]) | sel[4]), ((~ nose[3]) | sel[3]), ((~ nose[2]) | sel[2]), ((~ nose[1]) | sel[1]), ((~ nose[0]) | sel[0])},
		StageIn = StageIn_tmp,
		StageIn_tmp = {StageOut[1023:768], DFFStage[63:32], StageOut[735:256], DFFStage[31:0], StageOut[223:0], {32{1'b0}}},
...
//synthesis_resources = lut 657 reg 260 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  INTDIV_sign_div_unsign
	( 
	clken,
	clock,
	denominator,
...
`endif
	...
	always @ ( posedge clock or  posedge aclr)
		...
		else if  (clken == 1'b1)   DFF_Num_Sign1 <= num_choice[31];
	// synopsys translate_off
	initial
		DFF_q_is_neg0 = 0;
	// synopsys translate_on
	...
	always @ ( posedge clock or  posedge aclr)
		...
		else if  (clken == 1'b1)   DFF_q_is_neg1 <= q_is_neg;
	assign
	...
	assign
		...
		zero_wire = {32{1'b0}},
		zero_wire_2 = {32{1'b0}};
endmodule //INTDIV_sign_div_unsign

//synthesis_resources = lut 657 reg 260 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  INTDIV_lpm_divide
	( 
	clken,
	clock,
	denom,
...
`endif
	...
	INTDIV_sign_div_unsign   divider
	( 
	.clken(clken),
	.clock(clock),
	.denominator(denom),
...
module INTDIV (
	...
	INTDIV_lpm_divide	INTDIV_lpm_divide_component (
				.clken (clken),
				.clock (clock),
				.denom (denom),
				.numer (numer),
